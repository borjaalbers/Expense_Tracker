...
| `DATABASE_URL` | ✅ | `sqlite:///expense_tracker.db` locally, `sqlite:////data/expense_tracker.db` in Docker/Render | SQLAlchemy database connection string. Swap to Render Postgres in Branch 5.5. |
